        ...
        dialogues: [
          {
            speaker: "kabu",
            mood: "calm",
            text: "タマ助手、1,000人に1人しかかからない病気があるよ。感度99%（病気の人を99%陽性と見抜く）・特異度99%（健康な人を99%陰性と見抜く）の超高精度な検査で『陽性』が出たら、本当に病気である確率は何%だと思う？",
          },
          {
            speaker: "tama",
            mood: "confident",
            text: "どっちも99%正解する超優秀な検査なんだから、99%病気に決まってるにゃ！ 絶望的にゃ……！",
          },
        ],
        userPrompt: {
        ...
        dialogues: [
          {
            speaker: "kabu",
            mood: "pointing",
            text: "10,000匹のねこ住民がいるよ。『住民から1匹選んで検査』ボタンを押して、実際に猫を検査してみよう！",
          },
          {
            speaker: "tama",
            mood: "excited",
            text: "健康な猫が9,990匹もいるにゃ！ ボタンを押して検査してみるにゃ……！",
          },
        ],
      },
      {
        ...
        dialogues: [
          {
            speaker: "kabu",
            mood: "calm",
            text: "10,000匹を検査結果の4つの部屋（真陽性・偽陽性・偽陰性・真陰性）に仕分けしてみよう。スライダーで有病率や精度を変えることもできるよ。",
          },
          {
            speaker: "tama",
            mood: "shocked",
      ...
      },
      {
        ...
        dialogues: [
          ...
          },
          {
            speaker: "tama",
            mood: "excited",
            text: "分母（陽性判定された人全体）に偽陽性が大量に混ざるからなんだにゃ！ 陽性者の内訳バーグラフを見たら一発で理解できたにゃ！",
          },
        ],
      },
    ],
